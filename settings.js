...
export const logicalOperatorSymbols = new Map(Object.entries({
    "not": "\u00AC",
    "and": "\u2227",
    "or": "\u2228",
    "if": "\u27F6",
...
export const logicalOperatorNames = Array.from(logicalOperatorSymbols.keys());
/**
...
export const inferenceRuleSymbols = new Map(Object.entries({ "assume": "Assume" }));
