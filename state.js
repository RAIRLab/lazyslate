...
export let proofNodes = [];
export let proofLinks = [];
// Representations =====================================================================================================
/**
 ...
 */
export function verifyNodes(node, visited = []) {
 ...
 */
export function createNode(name, justification, expression, position) {
 ...
 */
export function deleteLink(fromNode, toNode) {
 ...
 */
export function setStateFromJSON(jsonString) {
    proofNodes = [];
    proofLinks = [];
    const jsonObject = JSON.parse(jsonString);
    //construct our nodes
    const nodes = jsonObject["nodes"];
    let idToNode = new Map; //Extreamly helpful for links later
 ...
 */
export function lookupNode(name) {
    for (const node of proofNodes) {
        if (name == node.name) {
            return node;
        }
